...
```json
{
  "$id": "cah-0.0.4-conformance-test-manifest.schema.json",
  ...
  "properties": {
    ...
    "normalizer_catalog": { "$ref": "cah-0.0.4-normalizer-catalog.schema.json#" },
    "tests": {
      "type": "array",
      "minItems": 1,
...
`json_pointers_required` enumerates RFC-6901 pointer strings that MUST appear in emitted diagnostics for the case.
...
```json
{
  "$id": "cah-0.0.4-changelog.schema.json",
