        ...
        "properties": {
          ...
          "constraints": {
            ...
            "items": {
              "type": "object",
              "properties": {
                "code": { "type": "string" },          // reference to error code on violation
                "description": { "type": "string" },   // brief machine-readable text
                "when": { "type": "string" }           // boolean expression over local context
              },
    ...
    "catalog": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "domain": { "type": "string" },
          "unit": { "type": "string" },                 // SI preferred; dimensionless allowed
          "policy": {
            "type": "object",
            "properties": {
          ...
          "params": { "type": "object", "additionalProperties": true },  // versioned coefficients
