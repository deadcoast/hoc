...
Defines numeric domains, comparison semantics, serialization format, rounding, and forbidden values for all CAH 0.0.3 computations (normalization, parity, metrics, commit objects).
...
```json
{
  "$id": "cah-0.0.3-unit-registry.schema.json",
...
Standardize optional features, discovery, and fail-closed gating for extensions beyond 0.0.3 core.
...
```json
{
  "$id": "cah-0.0.3-features-manifest.schema.json",
