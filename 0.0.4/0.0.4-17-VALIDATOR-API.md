...
* **Purpose:** Apply an adapter (ADP) from legacy versions to 0.0.4.
...
* **Purpose:** Liveness.
* **Response body:** `{ status:"ok", version:"0.0.4" }`

### 9) `GET /v1/version`

* **Purpose:** Report supported spec and feature gates.
* **Response body:** `{ spec_version:"0.0.4", features: FeaturesManifest["capabilities"] }`
