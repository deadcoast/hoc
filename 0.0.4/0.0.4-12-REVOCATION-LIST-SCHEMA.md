...
```json
{
  "$id": "cah-0.0.3-status-request.schema.json",
...
```json
{
  "$id": "cah-0.0.3-status-response.schema.json",
...
```json
{
  "$id": "cah-0.0.3-verifier-audit-log.schema.json",
  ...
  "$defs": {
    "event": {
      ...
      "properties": {
        ...
        "badge_level": { "enum": ["CAH-0.0.3-A","CAH-0.0.3-B","CAH-0.0.3-C"] },
        "issuer_id": { "type": "string" },
        "badge_digest": { "type": "string", "pattern": "^[a-f0-9]{64}$" },
