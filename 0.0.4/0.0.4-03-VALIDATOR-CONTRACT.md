...
3. When a pointer targets a missing node due to diagram supremacy adoption:
    - attach `json_ptr` to the **nearest parent** that exists and include a `note:"adopted_from_diagram"` field in the diagnostic (optional extension)
