...
```json
{
  "$id": "cah-0.0.3-incremental-ticket.schema.json",
...
```json
{
  "$id": "cah-0.0.3-privacy-policy.schema.json",
...
```json
{
  "$id": "cah-0.0.3-provenance-signature.schema.json",
...
```json
{
  "$id": "cah-0.0.3-normalizer-pipeline.schema.json",
...
* **Versioning:** `normalizer_version.major == 0` under spec `0.0.3`.
